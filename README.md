...
- [Data Preprocessing for VQA](https://youtu.be/6sULPLNN4Aw?si=N4eORm1Hf_NnMF_Q)

<b>Assumptions about the project:</b>

💡 A supervised classification task: We have inputs (images & questions) and labels.\
💡 The model needs to provide an answer based on labels, and not randomly.
